...
```bash
curl -X GET "http://localhost:5052/lighthouse/analysis/total_supply/0x7e76880eb67bbdc86250aa578958e9d0675e64e714337855204fb5abaaf82c2b" -H "accept: application/json" | jq
```
