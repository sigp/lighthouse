...
Options:
  ...
  -t, --testnet-dir <DIR>
      ...
      --vc-url <HTTP_ADDRESS>
          ...
          keymanager-API. If this value is not supplied then a 'dry
          run' will be conducted where no changes are made to the
          validator client. [default: http://localhost:5062]
  -h, --help
          Print help
...
Flags:
      ...
      --disable-malloc-tuning
          ...
          issues.
      --ignore-duplicates
          If present, ignore any validators which already exist on the
