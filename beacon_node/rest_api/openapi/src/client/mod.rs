...
impl<F, C> Api<C> for Client<F> where
            ...
            match response.status().as_u16() {
                200 => {
                    ...
                    Box::new(
                        ...
                        .map(move |body| {
                            NodeGenesisTimeGetResponse::RequestSuccessful(body)
                        })
            ...
            match response.status().as_u16() {
                200 => {
                    ...
                    Box::new(
                        ...
                        .map(move |body| {
                            NodeSyncingGetResponse::RequestSuccessful(body)
                        })
                    ) as Box<Future<Item=_, Error=_>>
                },
                500 => {
            ...
            match response.status().as_u16() {
                200 => {
                    ...
                    Box::new(
                        ...
                        .map(move |body| {
                            NodeVersionGetResponse::RequestSuccessful(body)
                        })
                    ) as Box<Future<Item=_, Error=_>>
                },
                500 => {
    ...
    fn validator_attestation_get(&self, param_validator_pubkey: swagger::ByteArray, param_poc_bit: i32, param_slot: i32, param_shard: i32, context: &C) -> Box<Future<Item=ValidatorAttestationGetResponse, Error=ApiError>> {
        let mut uri = format!(
        ...
        let mut query_string = self::url::form_urlencoded::Serializer::new("".to_owned());
        query_string.append_pair("validator_pubkey", &param_validator_pubkey.to_string());
        query_string.append_pair("poc_bit", &param_poc_bit.to_string());
        query_string.append_pair("slot", &param_slot.to_string());
        query_string.append_pair("shard", &param_shard.to_string());
                    ...
                    Box::new(
                        ...
                        str::from_utf8(&body)
                                             ...
                                             .and_then(|body|
                                                 ...
                                                 serde_json::from_str::<models::IndexedAttestation>(body)
                                                     .map_err(|e| e.into())
                                             )

                                 )
                        .map(move |body| {
                            ValidatorAttestationGetResponse::SuccessResponse(body)
                        })
                    ) as Box<Future<Item=_, Error=_>>
                },
                400 => {
    ...
    fn validator_attestation_post(&self, param_attestation: models::IndexedAttestation, context: &C) -> Box<Future<Item=ValidatorAttestationPostResponse, Error=ApiError>> {
        let mut uri = format!(
            "{}/validator/attestation",
            self.base_path
        );
        ...
        let mut query_string = self::url::form_urlencoded::Serializer::new("".to_owned());
        query_string.append_pair("attestation", &param_attestation.to_string());
    ...
    fn validator_block_get(&self, param_slot: i32, param_randao_reveal: swagger::ByteArray, context: &C) -> Box<Future<Item=ValidatorBlockGetResponse, Error=ApiError>> {
        let mut uri = format!(
            "{}/validator/block",
            self.base_path
        );
        ...
        let mut query_string = self::url::form_urlencoded::Serializer::new("".to_owned());
        query_string.append_pair("slot", &param_slot.to_string());
        query_string.append_pair("randao_reveal", &param_randao_reveal.to_string());
                    ...
                    Box::new(
                        ...
                        str::from_utf8(&body)
                                             ...
                                             .and_then(|body|
                                                 ...
                                                 serde_json::from_str::<models::BeaconBlock>(body)
                                                     .map_err(|e| e.into())
                                             )

                                 )
                        .map(move |body| {
                            ValidatorBlockGetResponse::SuccessResponse(body)
                        })
                    ) as Box<Future<Item=_, Error=_>>
                },
                400 => {
    ...
    fn validator_block_post(&self, param_beacon_block: models::BeaconBlock, context: &C) -> Box<Future<Item=ValidatorBlockPostResponse, Error=ApiError>> {
        let mut uri = format!(
            "{}/validator/block",
            self.base_path
        );
        ...
        let mut query_string = self::url::form_urlencoded::Serializer::new("".to_owned());
        query_string.append_pair("beacon_block", &param_beacon_block.to_string());
    ...
    fn validator_duties_get(&self, param_validator_pubkeys: &Vec<models::Pubkey>, param_epoch: Option<i32>, context: &C) -> Box<Future<Item=ValidatorDutiesGetResponse, Error=ApiError>> {
        let mut uri = format!(
            "{}/validator/duties",
            self.base_path
        );
        ...
        let mut query_string = self::url::form_urlencoded::Serializer::new("".to_owned());
        query_string.append_pair("validator_pubkeys", &param_validator_pubkeys.join(","));

        if let Some(epoch) = param_epoch {
            query_string.append_pair("epoch", &epoch.to_string());
        }
                    ...
                    Box::new(
                        ...
                        str::from_utf8(&body)
                                             ...
                                             .and_then(|body|
                                                 ...
                                                 serde_json::from_str::<Vec<models::ValidatorDuty>>(body)
                                                     .map_err(|e| e.into())
                                             )

                                 )
                        .map(move |body| {
                            ValidatorDutiesGetResponse::SuccessResponse(body)
                        })
                    ) as Box<Future<Item=_, Error=_>>
                },
                400 => {
            ...
            match response.status().as_u16() {
                200 => {
                    ...
                    Box::new(
                        ...
                        .map(move |body| {
                            NodeForkGetResponse::RequestSuccessful(body)
                        })
                    ) as Box<Future<Item=_, Error=_>>
                },
                500 => {
