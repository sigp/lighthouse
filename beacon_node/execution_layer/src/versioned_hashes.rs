...
pub fn verify_versioned_hashes(
    ...
    let versioned_hashes =
        extract_versioned_hashes_from_transactions(execution_payload.transactions())?;
...
pub fn extract_versioned_hashes_from_transactions(
    transactions: types::TransactionsRef,
...
mod test {
    ...
    fn test_extract_versioned_hashes() {
        ...
        struct TestTransactions(
            #[serde(with = "ssz_types::serde_utils::list_of_hex_var_list")] types::Transactions,
        );

        let TestTransactions(raw_transactions): TestTransactions = serde_json::from_str(r#"[
        ...
        let versioned_hashes =
            extract_versioned_hashes_from_transactions((&raw_transactions).into())
