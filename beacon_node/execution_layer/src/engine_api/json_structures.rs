...
impl<E: EthSpec> From<ExecutionPayloadBellatrix<E>> for JsonExecutionPayloadV2<E> {
    fn from(payload: ExecutionPayloadBellatrix<E>) -> Self {
...
impl<E: EthSpec> From<ExecutionPayloadDeneb<E>> for JsonExecutionPayloadV4<E> {
    fn from(payload: ExecutionPayloadDeneb<E>) -> Self {
...
impl<E: EthSpec> From<JsonExecutionPayloadV4<E>> for ExecutionPayloadDeneb<E> {
...
impl<E: EthSpec> From<JsonExecutionPayload<E>> for ExecutionPayload<E> {
    fn from(json_execution_payload: JsonExecutionPayload<E>) -> Self {
        match json_execution_payload {
            ...
            JsonExecutionPayload::V4(payload) => ExecutionPayload::Deneb(payload.into()),
        }
    }
}
