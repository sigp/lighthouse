...
use crate::{metrics, get_key_for_col, KeyValueStoreOp, DBColumn, ColumnIter, KeyValueStore, ColumnKeyIter, ItemStore};
use db_key::Key;
...
#[derive(Debug)]
pub struct RwTransaction<E: EthSpec> {
    env: Environment<E>
}
...
impl <E: EthSpec> RwTransaction<E> {
