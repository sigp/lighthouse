...
impl<E: EthSpec> ValidatorMonitor<E> {
    ...
    /// aggregated basis).
    #[instrument(level = "info", name = "validator_monitor", skip(self))]
    ...
    #[instrument(level = "info", name = "validator_monitor", skip(self, state))]
    ...
    #[instrument(level = "info", name = "validator_monitor", skip(self, func))]
    ...
    #[instrument(level = "info", name = "validator_monitor", skip(self, slot_clock))]
