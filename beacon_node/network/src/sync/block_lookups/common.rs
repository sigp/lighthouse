...
impl<T: BeaconChainTypes> RequestState<T> for BlockRequestState {
    type VerifiedResponseType = Arc<SignedBeaconBlock>;
...
impl<T: BeaconChainTypes> RequestState<T> for BlobRequestState {
    type VerifiedResponseType = FixedBlobSidecarList;
...
impl<T: BeaconChainTypes> RequestState<T> for CustodyRequestState {
    type VerifiedResponseType = DataColumnSidecarList;
