        ...
        Ok(gateway) => {
            ...
            match local_ip {
                IpAddr::V4(address) => {
                    ...
                    network_send.send(NetworkMessage::UPnPMappingEstablished{ tcp_socket, udp_sockets })
...
pub fn remove_mappings(tcp_port: Option<u16>, udp_ports: &[u16], log: &slog::Logger) {
    if tcp_port.is_some() || !udp_ports.is_empty() {
