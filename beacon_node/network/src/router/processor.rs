...
impl<T: BeaconChainTypes> Processor<T> {
    ...
    pub fn on_light_client_bootstrap(
        &mut self,
        peer_id: PeerId,
        request_id: PeerRequestId,
        request: LightClientBootstrapRequest,
    ) {
        self.send_beacon_processor_work(BeaconWorkEvent::light_client_bootstrap_request(
            peer_id, request_id, request,
        ))
    }

    /// Handle a `LightClientOptimisticUpdate` request from the peer.
    pub fn on_light_client_optimistic_update_rpc(
        &mut self,
        peer_id: PeerId,
        request_id: PeerRequestId,
    ...
    pub fn on_light_client_finality_update_rpc(
        &mut self,
        peer_id: PeerId,
        request_id: PeerRequestId,
