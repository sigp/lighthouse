use beacon_chain::validator_monitor::DEFAULT_INDIVIDUAL_METRICS_THRESHOLD;
...
pub struct Config {
    ...
    pub validator_monitor_individual_metrics_threshold: usize,
    #[serde(skip)]
...
impl Default for Config {
    fn default() -> Self {
        Self {
            ...
            validator_monitor_individual_metrics_threshold: DEFAULT_INDIVIDUAL_METRICS_THRESHOLD,
