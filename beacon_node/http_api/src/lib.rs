...
use eth2::types::{
    ...
    SignedBlockContentsWrapper, ValidatorId, ValidatorStatus,
};
...
pub fn serve<T: BeaconChainTypes>(
    ...
    let post_beacon_blocks = eth_v1
        ...
        .then(
            move |block_contents: SignedBlockContentsWrapper<T::EthSpec>,
                  task_spawner: TaskSpawner<T::EthSpec>,
                  chain: Arc<BeaconChain<T>>,
    ...
    let post_beacon_blocks_ssz = eth_v1
        ...
        .then(
            move |block_bytes: Bytes,
                  ...
                  log: Logger| {
                task_spawner.spawn_async_with_rejection(Priority::P0, async move {
                    let block_contents = SignedBlockContentsWrapper::<T::EthSpec>::from_ssz_bytes(
                        &block_bytes,
                        &chain.spec,
                    )
                    .map_err(|e| {
    ...
    let post_beacon_blocks_v2 = eth_v2
        ...
        .then(
            move |validation_level: api_types::BroadcastValidationQuery,
                  block_contents: SignedBlockContentsWrapper<T::EthSpec>,
                  task_spawner: TaskSpawner<T::EthSpec>,
                  chain: Arc<BeaconChain<T>>,
                  network_tx: UnboundedSender<NetworkMessage<T::EthSpec>>,
                  log: Logger| {
