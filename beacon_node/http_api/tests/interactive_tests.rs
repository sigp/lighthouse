...
use eth2::types::{BeaconBlock, DepositContractData, SignedBeaconBlock};
...
#[tokio::test(flavor = "multi_thread", worker_threads = 2)]
pub async fn broadcast_validation_block_only_gossip_valid() {
    ...
    let response: Result<(), eth2::Error> = tester.client.post_beacon_blocks_v2(&block).await;
