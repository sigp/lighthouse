...
pub const VOTING_KEY_PREFIX: &str = "voting";
pub const WITHDRAWAL_KEY_PREFIX: &str = "withdrawal";
pub const ETH1_DEPOSIT_DATA_FILE: &str = "eth1_deposit_data.rlp";
...
/// Builds a `LocalValidator`, both in-memory and on-disk.
#[derive(Default)]
...
impl LocalValidatorBuilder {
    ...
    pub fn build(self) -> Result<LocalValidator, String> {
        Ok(LocalValidator {
...
mod tests {
    ...
    fn random_keypairs_round_trip() {
        ...
        let created_dir = LocalValidatorBuilder::default()
            .spec(spec)
            .full_deposit_amount()
        ...
        let loaded_dir = LocalValidator::load_for_signing(created_dir.directory.clone())
