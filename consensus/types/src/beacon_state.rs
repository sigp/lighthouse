...
impl<T: EthSpec> BeaconState<T> {
    ...
    pub fn proposer_shuffling_decision_slot(&self) -> Slot {
        ...
        self.current_epoch().start_slot(T::slots_per_epoch()) - Slot::new(1)
    }
    ...
    pub fn attester_shuffling_decision_slot(&self, relative_epoch: RelativeEpoch) -> Slot {
        match relative_epoch {
            ...
            RelativeEpoch::Previous => self.previous_epoch() - Epoch::new(1),
        }
    ...
    pub fn update_pubkey_cache(&mut self) -> Result<(), Error> {
        ...
        {
            let success = self.pubkey_cache.insert(validator.pubkey, i);
            if !success {
