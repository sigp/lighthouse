...
impl<E: EthSpec> LightClientOptimisticUpdate<E> {
    ...
    pub fn is_latest(
        ...
        let prev_has_supermajority =
            prev_participants.saturating_mul(3) >= max_participants.saturating_mul(2);
        ...
        if attested_slot != prev_slot {
            return attested_slot > prev_slot;
        }
