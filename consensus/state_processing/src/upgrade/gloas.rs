...
use types::{
    BeaconState, BeaconStateError as Error, BeaconStateGloas, Builder, BuilderPendingPayment,
    ChainSpec, EthSpec, ExecutionPayloadBid, ExecutionRequestsGloas, Fork, PendingDeposit,
