...
pub fn process_operations<'a, T: EthSpec, Txns: Transactions<T>>(
    state: &mut BeaconState<T>,
    block_body: BeaconBlockBodyRef<'a, T, Txns>,
    proposer_index: u64,
...
/// the fork.
pub fn process_attestations<'a, T: EthSpec, Txns: Transactions<T>>(
    state: &mut BeaconState<T>,
    block_body: BeaconBlockBodyRef<'a, T, Txns>,
    proposer_index: u64,
    verify_signatures: VerifySignatures,
