use super::types::*;
use crate::error::{Error, Result, ok_or_error_validator};
use reqwest::{
    IntoUrl,
...
impl ValidatorClientHttpClient {
    ...
    pub fn new(server: SensitiveUrl, secret: String) -> Result<Self> {
        Ok(Self {
    ...
    pub fn new_unauthenticated(server: SensitiveUrl) -> Result<Self> {
        Ok(Self {
            client: reqwest::Client::new(),
            server,
            api_token: None,
    ...
    pub fn load_api_token_from_file(path: &Path) -> Result<Zeroizing<String>> {
    ...
    pub fn add_auth_token(&mut self, token: Zeroizing<String>) -> Result<()> {
    ...
    async fn get_response<U: IntoUrl>(&self, url: U) -> Result<Response> {
        let response = self
            .client
            .get(url)
    ...
    async fn delete_response<U: IntoUrl>(&self, url: U) -> Result<Response> {
        let response = self
            .client
            .delete(url)
            .headers(self.headers()?)
    ...
    async fn delete<U: IntoUrl>(&self, url: U) -> Result<()> {
    ...
    async fn get_unsigned<T: DeserializeOwned, U: IntoUrl>(&self, url: U) -> Result<T> {
    ...
    async fn patch<T: Serialize, U: IntoUrl>(&self, url: U, body: &T) -> Result<()> {
        let response = self
            .client
            .patch(url)
            .headers(self.headers()?)
    ...
    pub async fn get_lighthouse_version(&self) -> Result<GenericResponse<VersionData>> {
    ...
    pub async fn get_lighthouse_health(&self) -> Result<GenericResponse<Health>> {
        let mut path = self.server.full.clone();
    ...
    pub async fn get_lighthouse_validators(
        &self,
    ) -> Result<GenericResponse<Vec<ValidatorData>>> {
        let mut path = self.server.full.clone();
    ...
    ) -> Result<Option<GenericResponse<ValidatorData>>> {
        let mut path = self.server.full.clone();
    ...
    ) -> Result<GenericResponse<PostValidatorsResponseData>> {
        let mut path = self.server.full.clone();
    ...
    ) -> Result<GenericResponse<Vec<CreatedValidator>>> {
        let mut path = self.server.full.clone();
    ...
    ) -> Result<GenericResponse<ValidatorData>> {
        let mut path = self.server.full.clone();
    ...
    ) -> Result<ExportKeystoresResponse> {
        let mut path = self.server.full.clone();
    ...
    fn make_keystores_url(&self) -> Result<Url> {
    ...
    fn make_remotekeys_url(&self) -> Result<Url> {
        let mut url = self.server.full.clone();
        url.path_segments_mut()
            .map_err(|()| Error::InvalidUrl(self.server.clone()))?
            .push("eth")
    ...
    fn make_fee_recipient_url(&self, pubkey: &PublicKeyBytes) -> Result<Url> {
        let mut url = self.server.full.clone();
        url.path_segments_mut()
            .map_err(|()| Error::InvalidUrl(self.server.clone()))?
            .push("eth")
    ...
    fn make_graffiti_url(&self, pubkey: &PublicKeyBytes) -> Result<Url> {
        let mut url = self.server.full.clone();
        url.path_segments_mut()
            .map_err(|()| Error::InvalidUrl(self.server.clone()))?
            .push("eth")
    ...
    fn make_gas_limit_url(&self, pubkey: &PublicKeyBytes) -> Result<Url> {
        let mut url = self.server.full.clone();
        url.path_segments_mut()
            .map_err(|()| Error::InvalidUrl(self.server.clone()))?
            .push("eth")
    ...
    /// `GET lighthouse/auth`
    pub async fn get_auth(&self) -> Result<AuthResponse> {
        let mut url = self.server.full.clone();
        url.path_segments_mut()
            .map_err(|()| Error::InvalidUrl(self.server.clone()))?
            .push("lighthouse")
    ...
    pub async fn get_keystores(&self) -> Result<ListKeystoresResponse> {
    ...
    ) -> Result<ImportKeystoresResponse> {
        let url = self.make_keystores_url()?;
    ...
    pub async fn delete_keystores(
        &self,
        req: &DeleteKeystoresRequest,
    ) -> Result<DeleteKeystoresResponse> {
        let url = self.make_keystores_url()?;
        self.delete_with_unsigned_response(url, req).await
    }

    /// `GET eth/v1/remotekeys`
    pub async fn get_remotekeys(&self) -> Result<ListRemotekeysResponse> {
    ...
    ) -> Result<ImportRemotekeysResponse> {
        let url = self.make_remotekeys_url()?;
        self.post_with_unsigned_response(url, req).await
    }
    ...
    ) -> Result<DeleteRemotekeysResponse> {
        let url = self.make_remotekeys_url()?;
        self.delete_with_unsigned_response(url, req).await
    }
    ...
    ) -> Result<GetFeeRecipientResponse> {
    ...
    pub async fn delete_fee_recipient(&self, pubkey: &PublicKeyBytes) -> Result<Response> {
        let url = self.make_fee_recipient_url(pubkey)?;
    ...
    pub async fn delete_gas_limit(&self, pubkey: &PublicKeyBytes) -> Result<Response> {
        let url = self.make_gas_limit_url(pubkey)?;
        self.delete_with_raw_response(url, &()).await
    }
    ...
    pub async fn post_validator_voluntary_exit(
        ...
        pubkey: &PublicKeyBytes,
        epoch: Option<Epoch>,
    ) -> Result<GenericResponse<SignedVoluntaryExit>> {
        let mut path = self.server.full.clone();
    ...
    pub async fn delete_graffiti(&self, pubkey: &PublicKeyBytes) -> Result<()> {
        let url = self.make_graffiti_url(pubkey)?;
