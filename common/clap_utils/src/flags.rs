...
/// This macro constructs a constant for each given `(identifier, value)` tuple, and adds each constant to
/// a `Vec` generated by `lazy_static`.  The first argument will be used as the name of the `Vec`.
