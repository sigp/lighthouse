...
pub fn run_parse_ssz<T: EthSpec>(matches: &ArgMatches) -> Result<(), String> {
    ...
    match type_str {
        ...
        "signed_block_eip6110" => decode_and_print::<SignedBeaconBlockEip6110<T>>(&bytes, format)?,
        ...
        "block_eip6110" => decode_and_print::<BeaconBlockEip6110<T>>(&bytes, format)?,
        ...
        "state_eip6110" => decode_and_print::<BeaconStateEip6110<T>>(&bytes, format)?,
