...
# Spec commit: d1ce367e
FCR_TESTS_URL="${FCR_TESTS_URL:-https://github.com/user-attachments/files/26561030/fcr-fulu-d1ce367e.tar.gz}"
if [[ -n "${FCR_TESTS_URL}" ]]; then
	fcr_tarball="fcr-fulu-d1ce367e.tar.gz"
