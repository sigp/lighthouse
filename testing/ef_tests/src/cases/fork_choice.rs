...
use types::{
    ...
    DataColumnSidecarList, DataColumnSubnetId, Epoch, ExecutionBlockHash, ForkVersionDecode,
    Hash256, IndexedAttestation, IndexedPayloadAttestation, KzgProof, PayloadAttestationMessage,
